...
insert into ers.users (ers_username, ers_password, user_first_name, user_last_name, user_email, user_role_id) values ('bntufte', 'OX3GWvzzdGdnRXz9nUbk0w==:rh3n2J6dcdKo12NMOlcwKA==', 'Brandon', 'Tufte', 'btufte@economist.com', 1);
insert into ers.users (ers_username, ers_password, user_first_name, user_last_name, user_email, user_role_id) values ('mbernardet1', 'x9s4GE15z6SynC2dFhrHJg==:TWNercW10/vdak4ua34Asw==', 'Moyna', 'Bernardet', 'mbernardet1@google.it', 1);
insert into ers.users (ers_username, ers_password, user_first_name, user_last_name, user_email, user_role_id) values ('tosirin2', 'FB+sILKXVSpy5eo130QdYg==:1f1O0MIes7WSvYJKwdmwJQ==', 'Terrance', 'O''Sirin', 'tosirin2@intel.com', 1);
insert into ers.users (ers_username, ers_password, user_first_name, user_last_name, user_email, user_role_id) values ('salbion3', '4M94aNZyEM8wK+ciQssJXQ==:1hFJqB2mLtINFDhyH93Rig==', 'Sibylla', 'Albion', 'salbion3@webnode.com', 1);
insert into ers.users (ers_username, ers_password, user_first_name, user_last_name, user_email, user_role_id) values ('farp4', 'tfiYCeSXfujb81qgw50m5Q==:0lc9sH8hI2KqRwnBv7NZYQ==', 'Fidelia', 'Arp', 'farp4@vkontakte.ru', 1);
insert into ers.users (ers_username, ers_password, user_first_name, user_last_name, user_email, user_role_id) values ('aftufte', '/Cb21j6VCtfKpr0aR/KBSQ==:Pnsb5ilSFi2Wep4CYD9hWg==', 'Astrid', 'Tufte', 'atufte@opera.com', 2);
insert into ers.users (ers_username, ers_password, user_first_name, user_last_name, user_email, user_role_id) values ('hruzicka6', 'z2zrc/4w6lBBHPfy9Y8Dxg==:JOM8zMEaNYoo8+G9UCT7HA==', 'Hillier', 'Ruzicka', 'hruzicka6@example.com', 2);
insert into ers.users (ers_username, ers_password, user_first_name, user_last_name, user_email, user_role_id) values ('wflew7', 'WMLk2UONaNYuAZtvkYP0SQ==:wvvYwg9saizm0GSZ2p4zMg==', 'Washington', 'Flew', 'wflew7@house.gov', 2);
insert into ers.users (ers_username, ers_password, user_first_name, user_last_name, user_email, user_role_id) values ('cminot8', 'GTorjjQ9roBPTFK30tuZIA==:YYVTviDXNA+x5hh2V9Jsag==', 'Codi', 'Minot', 'cminot8@msn.com', 2);
insert into ers.users (ers_username, ers_password, user_first_name, user_last_name, user_email, user_role_id) values ('sabbet9', 'Dx3fjpqJdSNzV4hl4Ka7tQ==:B5CL/OUThiV6dRaEI1Ys2Q==', 'Sonnie', 'Abbet', 'sabbet9@123-reg.co.uk', 2);
insert into ers.users (ers_username, ers_password, user_first_name, user_last_name, user_email, user_role_id) values ('lstapforda', 'Uc/nUv8Ly6b5GfapHm1uhg==:9+Dyjtvjbg2S+dPd6BxzHQ==', 'Lindy', 'Stapford', 'lstapforda@rakuten.co.jp', 2);
insert into ers.users (ers_username, ers_password, user_first_name, user_last_name, user_email, user_role_id) values ('ccornwellb', 'cH1DiuixENyhahYtv1ux3Q==:eVaoRd4FAs8kKd9bbSM8uQ==', 'Cort', 'Cornwell', 'ccornwellb@oaic.gov.au', 2);
insert into ers.users (ers_username, ers_password, user_first_name, user_last_name, user_email, user_role_id) values ('cbignallc', 'txgfGjzelb3bNbSoMaKR1Q==:ZSFhpECTfJQNZHHF1V0E1Q==', 'Christine', 'Bignall', 'cbignallc@trellian.com', 2);
insert into ers.users (ers_username, ers_password, user_first_name, user_last_name, user_email, user_role_id) values ('pmouled', '3kt6nIrTA4zxqcxGpB/zng==:npCXPmearbtsDaJHt4yIBQ==', 'Phillipp', 'Moule', 'pmouled@drupal.org', 2);
insert into ers.users (ers_username, ers_password, user_first_name, user_last_name, user_email, user_role_id) values ('pchesee', 'mG1hTbui+/Ho3m6aQoUicA==:FZANKoKalGuAoFOfH7YO+g==', 'Parsifal', 'Chese', 'pchesee@state.tx.us', 2);
insert into ers.users (ers_username, ers_password, user_first_name, user_last_name, user_email, user_role_id) values ('ckingdomf', 'lHS9QgwMHcCewtsN3jkD5A==:GHT4AowVeR7cMuhQu4moHQ==', 'Clemente', 'Kingdom', 'ckingdomf@furl.net', 2);
insert into ers.users (ers_username, ers_password, user_first_name, user_last_name, user_email, user_role_id) values ('charling', 'nYodq5C7p0ig6Ke2xWt4kg==:ydOB4Ltf6afY2fGdnkqhNQ==', 'Cyrille', 'Harlin', 'charling@hostgator.com', 2);
insert into ers.users (ers_username, ers_password, user_first_name, user_last_name, user_email, user_role_id) values ('ispridgeonh', 'gt367QypLU/0kL7xvZpH+g==:6UD06Pd0If3SnvVHQ8ANuQ==', 'Ingamar', 'Spridgeon', 'ispridgeonh@virginia.edu', 2);
insert into ers.users (ers_username, ers_password, user_first_name, user_last_name, user_email, user_role_id) values ('jhiscokei', '4e86cw6Mut7swlrYEgC5FA==:oxLU8ootxRXdBnpE7BcumQ==', 'Janna', 'Hiscoke', 'jhiscokei@yolasite.com', 2);
insert into ers.users (ers_username, ers_password, user_first_name, user_last_name, user_email, user_role_id) values ('wwhyliej', '74UpycstA4loOYCkmsYfBg==:GhKOZ83+yqgAkc5QXR2KPw==', 'Wandis', 'Whylie', 'wwhyliej@ucla.edu', 2);
insert into ers.users (ers_username, ers_password, user_first_name, user_last_name, user_email, user_role_id) values ('acampionek', 'oXiNABYWEfveO6Rc3Li0xw==:JDi4u7HiXO3mVshhm5pHbw==', 'Adelaida', 'Campione', 'acampionek@joomla.org', 2);
insert into ers.users (ers_username, ers_password, user_first_name, user_last_name, user_email, user_role_id) values ('dterbeckl', 'plLwPjNOkz0/E5HOJnoeUg==:dx2SsQRGBT3qAKWAP4GJGQ==', 'Damita', 'Terbeck', 'dterbeckl@instagram.com', 2);
insert into ers.users (ers_username, ers_password, user_first_name, user_last_name, user_email, user_role_id) values ('nbernardellim', '5oV2llRU0ivl/kvK6r/Cxw==:iSbnGKcdaVLE8tc7EGdOFA==', 'Nanine', 'Bernardelli', 'nbernardellim@yelp.com', 2);
insert into ers.users (ers_username, ers_password, user_first_name, user_last_name, user_email, user_role_id) values ('vnicholn', 'gwwn0P5ZAVBJSEuinP1j/Q==:PhJ9qP5+df3VUtoBwLM63Q==', 'Veradis', 'Nichol', 'vnicholn@walmart.com', 2);
insert into ers.users (ers_username, ers_password, user_first_name, user_last_name, user_email, user_role_id) values ('rmoulino', 'MwS8qO75IT2DMqSgdSq4sA==:8lBA73FIjP5OcUXKx2GnSw==', 'Roddy', 'Moulin', 'rmoulino@sfgate.com', 2);
